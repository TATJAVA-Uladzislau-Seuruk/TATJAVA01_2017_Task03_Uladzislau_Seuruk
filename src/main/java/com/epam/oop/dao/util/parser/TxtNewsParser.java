...
public class TxtNewsParser {
     ...
     */
    public static News parse(String params) throws ItemParsingException {
        if (params == null) {
    ...
    private static Map<String, String> makeParametersMap(String line) throws ItemParsingException  {
    ...
    private static String[] parseParameter(String line) throws ItemParsingException {
